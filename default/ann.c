...
float linear_interpolation(float val)
{
	int neg_input = 0;
	if(val < 0.0)
	{
	...
	if(val < 0.1875){ 
		...
		val = 0.922796 *val + 0.012309;
	} 
	else if(val >= 0.375 && val < 0.5625){ 
		val = 0.807854 * val + 0.055412;
	} 
	else if(val >= 0.5625 && val < 0.75){ 
		val = 0.668368 * val + 0.133873;
	} 
	else if(val >= 0.75 && val < 0.9375){ 
		val = 0.527587 * val + 0.239459;
	} 
	else if(val >= 0.9375 && val < 1.125){ 
		val = 0.401224 * val + 0.357924;
	} 
	else if(val >= 1.125 && val < 1.3125){ 
		val = 0.296563 * val + 0.475668;
	} 
	else if(val >= 1.3125 && val < 1.5){ 
		val = 0.214622 * val + 0.583215;
	} 
	else if(val >= 1.5 && val < 1.6875){ 
		val = 0.152959 * val + 0.675710;
	} 
	else if(val >= 1.6875 && val < 1.875){ 
		val = 0.107825 * val + 0.751873;
	} 
	else if(val >= 1.875 && val < 2.0625){ 
		val = 0.075424 * val + 0.812626;
	} 
	else if(val >= 2.0625 && val < 2.25){ 
		val = 0.052474 * val + 0.859959;
	} 
	else if(val >= 2.25 && val < 2.4375){ 
		val = 0.036370 * val + 0.896193;
	} 
	else if(val >= 2.4375 && val < 2.625){ 
		val = 0.025143 * val + 0.923561;
	} 
	else if(val >= 2.625 && val < 2.8125){ 
		val = 0.017350 * val + 0.944017;
	} 
	else if(val >= 2.8125){ 
		val = 0.011957 * val + 0.959183;
	} 
...
float ann_activation(int activation, float sum)
{
	...
	case 3:
		...
		break;
	case 4:
		result = discon_approx(sum);
		break;
	case 5:
		result = linear_interpolation(sum);
		break;
	default:
		result = sigmoid(sum);
		break;
